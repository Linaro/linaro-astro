...
“Texas Instruments is excited to be a founding partners of Linaro’s ONELab initiative. ONELab will play a vital role in continuously assessing the compliance of TI platforms with Arm SystemReady IR standards. This will give our customers confidence that our platforms meet, and will continue to meet, Arm’s rigorous standards. As a committed partner of the ONELab Advisory Board, we are dedicated to ensuring that the ONELab service provides true value to our customers.” said Artem Aginskiy, General Manager, Arm-based Processors, Texas Instruments.
