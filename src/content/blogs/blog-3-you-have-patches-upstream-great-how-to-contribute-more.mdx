---
title: "Becoming a Kernel Developer (3/3): You have patches upstream, great! How to contribute more!"
...
Once you are comfortable with reporting, the next step is to conduct a deeper investigation. Running regression tests is very helpful. For those seeking more adventure, tracing the regression's origin and "bisecting" issues ([doing a binary search to pinpoint when a bug was introduced](https://git-scm.com/book/en/v2/Git-Tools-Debugging-with-Git#_binary_search)) are options. The truly brave can even propose and aim to get a fix accepted into the main Linux codebase—how cool is that?
...
![](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1759326507/linaro-website/images/blog/image4-2_esv5pt.png)
