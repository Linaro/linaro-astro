...
description: >-
  In this blog, learn about the WindowsPerf GUI, a powerful Visual Studio 2022
  extension developed by the WindowsPerf team. Find out more about what exactly
  WindowsPerf is, and why we need a graphical interface.
date: 2023-09-03T23:09:28.000Z
image: >-
  https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/Chip_background_UNDER_2MB
tags:
  - windows-on-arm
...
![WindowsPerf settings UI tutorial](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1712246633/linaro-website/images/blog/update-settings.gif "WindowsPerf settings UI tutorial")

WindowsPerf settings UI tutorial

### Gain Insights with Host Data

Beyond the primary profiling functionalities, we realized the importance of understanding the environment in which WindowsPerf operates. With the Tools -> WindowsPerf _Host Data_ pathway, users can pull up a detailed window highlighting various tests executed by WindowsPerf and their corresponding results (the result of executing `wperf test` command). See this feature in action here:

![WindowsPerf additional host data UI tutorial](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/wperf-host-data "WindowsPerf additional host data UI tutorial")
...
To access this treasure trove of information, simply head to View -> Output and select _WindowsPerf_ Output from the dropdown.
