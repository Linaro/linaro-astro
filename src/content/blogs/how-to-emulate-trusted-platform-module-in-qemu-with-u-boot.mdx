...
description: In this blog, Linaro Tech Lead Ilias Apalodimas provides a step by
  ...
  here!
date: 2022-01-06T11:08:44.000Z
image: linaro-website/images/blog/Trusted_Services2
tags:
  - u-boot
  - qemu
...
The qemu defconfig includes the needed CONFIG\_TPM, CONFIG\_TPM2\_MMIO and CONFIG\_EFI\_TCG2\_PROTOCOL options. Make sure you enable CONFIG\_CMD\_EFIDEBUG as well, since we will need it to boot our kernel.
