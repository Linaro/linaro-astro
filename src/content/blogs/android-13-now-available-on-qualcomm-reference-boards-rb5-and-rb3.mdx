...
![An image of a Qualcomm RB5 running Android 13 Easter Egg](/linaro-website/images/blog/qualcomm-rb5-running-android-13-easter-egg)
...
* For android13.0.0\_r3 based images: [https://people.linaro.org/\~amit.pundir/db845c-userdebug-android13/](https://people.linaro.org/~amit.pundir/db845c-userdebug-android13/)
* For aosp-master-android13 images: [https://people.linaro.org/\~sumit.semwal/db845c-userdebug-aosp-master-android13/](https://people.linaro.org/~sumit.semwal/db845c-userdebug-aosp-master-android13/)
...
One can also download AOSP db845c-userdebug prebuilts from our daily build page  [https://snapshots.linaro.org/96boards/dragonboard845c/linaro/aosp-master/](https://snapshots.linaro.org/96boards/dragonboard845c/linaro/aosp-master/)

For advanced users who want to build the AOSP images from source, please follow the instructions from here [https://source.android.com/docs/setup/build/devices](https://source.android.com/docs/setup/build/devices)
