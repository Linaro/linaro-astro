...
In this demo, Linaro will show how to use LLMs to find regressions in post-commit CI and avoid bisecting. For the purpose of this demonstration, we will use Claude Sonnet 3.5 and the LLVM buildbots.
