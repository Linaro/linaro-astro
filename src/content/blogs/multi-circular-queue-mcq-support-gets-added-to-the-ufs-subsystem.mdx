...
![Data transfer between the HCI driver and the UFS device](/linaro-website/images/blog/data-transfer-between-the-hci-driver-and-the-ufs-device)
...
![Completion queue](/linaro-website/images/blog/completion-queue)
...
![Host memory](/linaro-website/images/blog/host-memory)
