...
![Booting an x86-64 Android with 1 virtual cpu](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image6_znohkp.png "Booting an x86-64 Android with 1 virtual cpu")

Booting an aarch64 Android with 1 virtual cpu:

`qemu-system-aarch64 –accel tcg -smp 1 -cpu max`

![Booting an aarch64 Android with 1 virtual cpu](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image1_bj7q8a.png "Booting an aarch64 Android with 1 virtual cpu")

The QEMU developer will see:

![Perf report](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image9_dhp1et.png "Perf report")
...
![1 CPU](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image3_iheqk1.png "1 CPU")

2 cpus:

![2 CPUs](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image2_tklv0y.png "2 CPUs")

4 cpus:

![4 CPUs](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image5_go9npa.png "4 CPUs")

8 cpus, and the (newcomer) QEMU developer that I am will see:

![8 CPUs](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image10_mejpa1.png "8 CPUs")
...
![The difference between emulation of x86-64 and aarch64 architectures](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image8_ikel15.png "The difference between emulation of x86-64 and aarch64 architectures")
...
![Android boot time using QEMU](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image7_kizndw.png "Android boot time using QEMU")

Beyond absolute time, representing this as a slowdown factor is more interesting.

![Android boot time slowdown using QEMU](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image4_gwwshp.png "Android boot time slowdown using QEMU")
