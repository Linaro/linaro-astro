...
date: 2023-10-05T10:03:05.000Z
image: >-
  https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/screenshot-2023-10-05-at-11.34.24
tags:
  - android
author: amit-pundir
related: []
...
![Easter-egg Image of Android 14 running on RB5](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image-of-rb5-running-android-14)

![Easter-egg Image of Android 14 running on Hikey960](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/image-of-hikey960-running-android-14)

## How to get Android 14 to boot on Linaro reference devboards?

Since Android 13, we have enabled booting the same set of AOSP images (db845c-userdebug) on both DB845c and RB5. Interested developers can download the db845c-userdebug prebuilt images that we used for smoke testing Android 14 from here: [https://releases.devboardsforandroid.linaro.org/android14-release/db845c-userdebug/](https://releases.devboardsforandroid.linaro.org/android14-release/db845c-userdebug/)

For Hikey960, users can download the hikey960-userdebug prebuilt images for Android 14 from here: [https://releases.devboardsforandroid.linaro.org/android14-release/hikey960-userdebug/](https://releases.devboardsforandroid.linaro.org/android14-release/hikey960-userdebug/)

For advanced users who want to build the AOSP images from source, please follow the build instructions from here [https://source.android.com/docs/setup/build/devices](https://source.android.com/docs/setup/build/devices).
...
To learn more about the work we do around devboards and AOSP, connect with us on IRC at #aosp-developers and/or #linaro-android on OFTC. You could also contact us at amit.pundir@linaro.org or sumit.semwal@linaro.org
