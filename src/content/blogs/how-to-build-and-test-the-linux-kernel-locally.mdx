...
<video controls loop class="object-contain mx-auto">
  <source src="https://static.linaro.org/videos/plan-yaml.mp4" type="video/mp4" />
...
For more information, check out the session we presented at Linaro Connect Madrid 2024 titled "[MAD24-214 Modern CI Solutions for Linux Kernel Testing](https://resources.linaro.org/en/resource/2f69EFtmXwFEt8zcESmEi2)".
