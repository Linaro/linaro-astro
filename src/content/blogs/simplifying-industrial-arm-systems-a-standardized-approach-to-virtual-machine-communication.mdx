...
\[ Android Guest ]  \[ Linux Guest ]  \[ RTOS Guest ]
...
\[  Accelerators  |  Real-time I/O  |  Security ]

Figure 1: Architectural overview of Virtio-msg enabling communication between diverse software domains and hardware subsystems
