...
![Firmware Encryption](/linaro-website/images/blog/firmware-encryption)
...
![class=medium-inline left Encrypt then sign image](/linaro-website/images/blog/encrypt-then-sign-image)
...
![class=medium-inline left Encrypt then sign image](/linaro-website/images/blog/sign-then-encrypt-image)
...
![class=medium-inline left Sign then encrypt then mac](/linaro-website/images/blog/sign-then-encrypt-then-mac)
...
![Protecting secret key](/linaro-website/images/blog/protecting-secret-key-image-1)

Subsequent boot sequence leveraging only Binding Secret Symmetric Key (BSSK):

![Protecting secret key](/linaro-website/images/blog/protecting-secret-key-image-2)

<iframe width="560" height="315" src="https://www.youtube.com/embed/JJjCUSDKb30?si=4crc_GiiHl_1P-hS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
