...
date: 2022-07-12T08:38:03.000Z
image: linaro-website/images/blog/code-background_1
tags:
  - arm
author: leo-yan
related: []
...
![Shared Data Cache Line Distribution Pareto Image](/linaro-website/images/blog/shared-cache-line-distribution-pareto-image)
...
![Using perf to dump Arm SPE Raw Trace Data Image](/linaro-website/images/blog/using-perf-to-dump-arm-spe-raw-trace-data-image)
...
The rest of the work was to support the flag PERF\_MEM\_SNOOPX\_PEER in perf c2c, we need to let perf c2c tool sort cache lines based on this new flag.  Similar to HITM tags, we treat the data sources “Peer core”, “Local cluster”, “Peer cluster” as local peer accesses, and “Remote” as remote peer accesses, the remote peer access accounting is expected to be helpful for NUMA performance analysis.
...
![Perf c2c outputs with Arm SPE trace data image](/linaro-website/images/blog/perf-c2c-outputs-with-arm-spe-trace-data-image)
