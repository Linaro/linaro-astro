...
  The following repositories now live under the KernelCI GitHub namespace:
...
We look forward to collaborating with KernelCI and the broader community to continue improving Linux kernel build and test infrastructure. We look forward to collaborating with KernelCI and the broader community to continue improving Linux kernel build and test infrastructure.
