...
* -s, --socket-path: Path of the vhost-user Unix domain sockets. This is
  suffixed with 0,1,2..socket\_count-1 by the daemon to obtain actual socket
  paths.
