...
![Existing boot flow on Qualcomm devices](/linaro-website/images/blog/existing-boot-flow-on-qualcomm-devices)
...
![Unified Boot using U-boot](/linaro-website/images/blog/unified-boot-using-u-boot)
