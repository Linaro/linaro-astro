...
description: This article takes a technical deep dive into how virtio-msg works,
  from its message-based control plane and shared-memory data plane to its
  separation of transport and bus-specific functionality. It explores the
  protocol, initialization flow, notifications, and example bus bindings such as
  FF-A, PCI, and Xen.
...
related: []
---
In the first article**\[MUST ADD THE LINK HERE]**, we explored the problem that virtio-msg is designed to solve: bringing standard Virtio devices to environments where PCI and MMIO are not natural communication mechanisms. Rather than introducing a new device model, virtio-msg keeps Virtio’s existing programming model while replacing register accesses with structured messages.
...
![](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1787239046/linaro-website/image5_sbah4s.png)
...
![](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1787239046/linaro-website/image1_g83yfk.png)
...
![](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1787239045/linaro-website/image3_hqw6nr.png)
...
![](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1787239047/linaro-website/image4_mawa5g.png)
...
* [Virtio specification source **(`transport-msg.tex`**](https://github.com/Linaro/virtio-msg-spec/)**)** – The current draft specification defining the virtio-msg transport protocol, message formats, and transport semantics.
...
* [Linux Kernel virtio-msg branch ](https://git.kernel.org/pub/scm/linux/kernel/git/vireshk/linux.git)and [RFC](https://lore.kernel.org/all/cover.1753865268.git.viresh.kumar@linaro.org/) - Experimental kernel support for virtio-msg, including the original Linux RFC discussion and prototype implementation.
