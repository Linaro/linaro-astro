...
![Amazon S3 bucket and using Amazon CloudFront](/linaro-website/images/blog/amazon_diagram)
...
One can even run the application locally with *“S3\_BUCKET=storage.dev.lkft.org S3\_REGION=us-east-1 ROOT\_INDEX\_LISTING=True FLASK\_APP=tuxpub flask run”*.
