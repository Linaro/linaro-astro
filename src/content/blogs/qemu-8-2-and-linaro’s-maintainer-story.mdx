...
![Diagram of the ARM security architecture showing the various security states and exception levels interact.](/assets/images/content/arm-cca-software-architecture.png)
