...
![Debian running on top of latest linux-next, with GPU rendering, on Snapdragon X Elite (X1E80100) Compute Reference Device](/linaro-website/images/blog/debian-running)
