...
description: >-
  In this blog post, we talk about tracking the size of LLVM generated code and
  look at the results on the latest releases.
date: 2023-10-18T10:13:54.000Z
image: >-
  https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/Code_Upstream_72
tags:
  - open-source
  - toolchain
...
This blog post will be about one of these activities: the automated tracking of code size. We'll compare between the latest LLVM releases \[[6](https://docs.google.com/document/d/1Y98bqJ9xPyNSfGESUBlFrFkYEbIo_aRBaZ9rFTGaUFs/edit#bookmark=id.iytzetzdrla7)], and take a quick look at the largest variations.<br />
...
There are also several TCWG Jenkins jobs that measure code size on different benchmarks, targets and optimization levels, aiming at detecting significant regressions and improvements, identifying exact responsible commits and notifying developers \[[11](https://docs.google.com/document/d/1Y98bqJ9xPyNSfGESUBlFrFkYEbIo_aRBaZ9rFTGaUFs/edit#bookmark=id.6akgup371zc2)].<br />

### EVOLUTION OF THE CODE SIZE ON SPEC BENCHMARK (AT -Oz OPTIMIZATION LEVEL)

![Figure 1: Evolution of code size (AArch64) width=70%](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-1-evolution-of-code-size-aarch64-)

*Figure 1: Evolution of code size (AArch64) <br />*

![Figure 2: Evolution of code size (X86\_64) width=70%](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-2-evolution-of-code-size-x86_64-)

*Figure 2: Evolution of code size (X86\_64) <br />*
...
* On average, code size is smaller from release to release since LLVM 10.0. It seems this is not the case on x86\_64, maybe because size is less important there (size variations on target x86\_64 were not specifically analysed).
...
![Figure 3: Evolution of code size - fixed (AArch64)](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-3-evolution-of-code-size-fixed-aarch64-)

*Figure 3: Evolution of code size - fixed (AArch64) <br />*

### COMMITS IMPACTING -Oz CODE SIZE

![\[Figure 4: Commits impacting code size (AArch64)](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-4-commits-impacting-code-size-aarch64-)
...
One can observe that MachineOutliner (V10, V11, V13) and AArch64 target specific patches (V4, V8, V12, V15) represent almost half of these variations. The remaining commits are mostly about generic optimizations (like MachineSink or AggressiveInstCombine). <br />
...
![Figure 5: impact of inlining flags on deepsjeng](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-5-impact-of-inlining-flags-on-deepsjeng-)

*Figure 5: impact of inlining flags on deepsjeng <br />*

![Figure 6: impact of optimization flags on AOSP](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-6-impact-of-optimization-flags-on-aosp)

*Figure 6: impact of optimization flags on AOSP <br />*
...
![Figure 7: code size for inline-threshold values](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-7-code-size-for-inline-threshold-values)

*Figure 7: code size for inline-threshold values <br />*
...
![Figure 8: LNT dashboard](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/figure-8-lnt-dashboard-14-)

*Figure 8: LNT dashboard \[[14](https://docs.google.com/document/d/1Y98bqJ9xPyNSfGESUBlFrFkYEbIo_aRBaZ9rFTGaUFs/edit#bookmark=id.de9gruo50m55)]<br />*
...
\[5] Android Open Source Project [https://source.android.com/](https://source.android.com/)

\[6] The LLVM Compiler Infrastructure Project [https://llvm.org/](https://llvm.org/)

\[7] Standard Performance Evaluation Corporation [https://www.spec.org](https://www.spec.org)

\[8] Linaro LNT dashboard (WIP) [http://llvm.validation.linaro.org:38000/](http://llvm.validation.linaro.org:38000/)

\[9] [https://ci.linaro.org/view/tcwg-all/job/tcwg-lnt-run-spec-codesize/](https://ci.linaro.org/view/tcwg-all/job/tcwg-lnt-run-spec-codesize/)

\[10] LLVM LNT [http://lnt.llvm.org/](https://ci.linaro.org/view/tcwg-all/job/tcwg-lnt-run-spec-codesize/)

\[11] [https://ci.linaro.org/view/tcwg\_bmk/](https://ci.linaro.org/view/tcwg_bmk/)

\[12] [https://ci.linaro.org/view/tcwg\_aosp/](https://ci.linaro.org/view/tcwg_aosp/)

\[13] [https://www.slideshare.net/linaroorg/bkk16308-the-tool-called-autotuned-optimization-system-atos](https://www.slideshare.net/linaroorg/bkk16308-the-tool-called-autotuned-optimization-system-atos)
