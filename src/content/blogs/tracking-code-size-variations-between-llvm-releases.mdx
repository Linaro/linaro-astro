...
![Figure 1: Evolution of code size (AArch64) width=70%](/linaro-website/images/blog/figure-1-evolution-of-code-size-aarch64-)

*Figure 1: Evolution of code size (AArch64) <br />*

![Figure 2: Evolution of code size (X86\_64) width=70%](/linaro-website/images/blog/figure-2-evolution-of-code-size-x86_64-)
...
![Figure 3: Evolution of code size - fixed (AArch64)](/linaro-website/images/blog/figure-3-evolution-of-code-size-fixed-aarch64-)

*Figure 3: Evolution of code size - fixed (AArch64) <br />*

### COMMITS IMPACTING -Oz CODE SIZE

![\[Figure 4: Commits impacting code size (AArch64)](/linaro-website/images/blog/figure-4-commits-impacting-code-size-aarch64-)
...
![Figure 5: impact of inlining flags on deepsjeng](/linaro-website/images/blog/figure-5-impact-of-inlining-flags-on-deepsjeng-)

*Figure 5: impact of inlining flags on deepsjeng <br />*

![Figure 6: impact of optimization flags on AOSP](/linaro-website/images/blog/figure-6-impact-of-optimization-flags-on-aosp)
...
![Figure 7: code size for inline-threshold values](/linaro-website/images/blog/figure-7-code-size-for-inline-threshold-values)
...
![Figure 8: LNT dashboard](/linaro-website/images/blog/figure-8-lnt-dashboard-14-)
