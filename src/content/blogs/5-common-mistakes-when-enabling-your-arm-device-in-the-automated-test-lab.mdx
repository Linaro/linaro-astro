...
It was supposed to be simple. Manuel had just received a new Arm development board and a [Linaro Automation Appliance (LAA)](<https://hub.linaro.com/library/laa/laa>). Connect a few cables, run a test, and you are done. Two hours, tops.
...
✅ Serial cable connected via [Flylead Mechanical Interface Board (MIB)](<https://hub.linaro.com/library/laa/hardware/mibs/flylead>)
...
The [LAA](https://hub.linaro.com/library/laa/laa) is an i.MX-based device that controls your DUT remotely. It provides:
...
**Note: Linaro handles LAA registration and project association internally.** If you can’t access your LAA, reach out to your Linaroaccount manager or contact us [here](https://www.linaro.org/solutions/onelab). 
