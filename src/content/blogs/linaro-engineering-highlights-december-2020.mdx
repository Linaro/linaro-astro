...
![Core Engineering icon](/linaro-website/images/blog/core-eng)
...
![Zephyr Project icon](/linaro-website/images/blog/zephyr-iot)
...
![Device Tree.org icon](/linaro-website/images/blog/devicetree-logo_vertical-devicetree)
...
![Photo of Mark Orvek](/linaro-website/images/blog/mark-orvek)
...
![Foundational Technologies Team Patches and Stewardship Table](/linaro-website/images/blog/building-fundamentals-2020)
...
![Linaro Consumer Group icon](/linaro-website/images/blog/LCG)
...
As Android continues to evolve, the team focussed on enabling new Android features on the current devices - both the development boards and formfactor devices. GKIv2 was implemented on all the devices and continues to be validated. Relevant patches were posted upstream, keeping in line with the upstream-focus of the GKI effort. New features such as FBE, replacing ION with dmabuf heaps, and clk\_sync\_state were added and validated on the devices.
...
Our Android graphics open stack focus with the Dragonboard 845c continued, where we kept aosp/master libdrm, Mesa GL and drm\_hwcomposer in sync with the upstream with regular merges and fixes.
...
![Linaro IoT and Embedded Group](/linaro-website/images/blog/lite)
...
![MCU Boot icon](/linaro-website/images/blog/mcuboot-logo)
...
![Linaro Edge Networking Group icon](/linaro-website/images/blog/ledge)
...
* NetDev presentation on [page\_pool API and XDP](https://netdevconf.info/0x14/session.html?tutorial-add-XDP-support-to-a-NIC-driver)
...
![SQUAD logo](/linaro-website/images/blog/squad)
...
![LKFT logo](/linaro-website/images/blog/lkft)
...
![tuxsuite logo](/linaro-website/images/blog/tuxsuite)
...
![tuxmake logo](/linaro-website/images/blog/tuxmake)
...
![tuxpub logo](/linaro-website/images/blog/tuxpub)
...
![tuxboot logo](/linaro-website/images/blog/tuxboot)
...
![HPC Supercomputer image](/linaro-website/images/blog/hpc-supercomputer-image)
