...
Rémi contributed to multiple Open Source projects, including [VLC](https://www.videolan.org/vlc) or [V8](https://v8.dev/). Rémi is the maintainer and technical leader of [LAVA](https://lava.readthedocs.io), the open source testing automation software created by Linaro 20 years ago.

In the last years, Rémi led the development of the [Linaro Automation Appliance](https://hub.linaro.com/library/laa/laa), one box that automates embedded device testing, from firmware to user-space, on your own hardware.
