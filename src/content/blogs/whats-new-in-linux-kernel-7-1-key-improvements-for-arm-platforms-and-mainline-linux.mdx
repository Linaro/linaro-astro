...
title: What's new in Linux Kernel 7.1? Key Improvements for Arm Platforms and
  Mainline Linux
description: The Linux 7.1 release includes contributions from Linaro engineers
  across platform standardization, scheduler performance, power management,
  hardware enablement, and kernel quality.
