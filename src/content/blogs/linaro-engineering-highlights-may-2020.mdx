...
image: linaro-website/images/blog/open_source_keyboard_under_2mbjpg
tags:
  - iot-embedded
  - ai-ml
author: jon-burcham
...
![class=small-inline left AI icon](/linaro-website/images/blog/ai)
...
![class=small-inline left Core Engineering icon](/linaro-website/images/blog/core-eng)
...
![class=small-inline left LKFT icon](/linaro-website/images/blog/lkft)
...
![sample file](/linaro-website/images/blog/tuxpub_lrg)
...
![class=small-inline left Multimedia icon](/linaro-website/images/blog/multimedia)
...
![class=small-inline left Raspberry Pi Libcamera icon](/linaro-website/images/blog/pi-lib-camera)
...
![class=small-inline left Ledge icon](/linaro-website/images/blog/ledge)
...
![class=small-inline left Lite icon](/linaro-website/images/blog/lite)
...
Additionally, the **srec\_cat** utility is required when merging signed application images at the end of the build process. This can be installed via the **srecord** package available on both Linux(-y) distributions and OS X via some variation of:
...
![class=small-inline left Stewardship icon](/linaro-website/images/blog/stewardship)
