...
description: >-
  In this article, David Spickett talks about how Top Byte Ignore works and how
  to use it. Read more here!
date: 2023-02-08T09:32:00.000Z
image: >-
...
![Symbol table entry](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/symbol-table-entry-)
...
I’ve used the “packed” attribute. Without it this structure takes up 16 bytes due to the 6 bytes of padding added after “reference\_count”. “packed” tells the compiler to put all the fields as close together as possible giving a size of 10 bytes.
...
![TBI for symbol table](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/tbi-for-symbol-table-)
...
* Any type that is greater than 56 bits will require a heap allocation, e.g. uint64\_t.
