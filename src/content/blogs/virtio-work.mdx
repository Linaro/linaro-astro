...
description: >
  In this article, Alex Bennee provides a summary of the history of VirtIO and
  the areas Linaro is working on for the future. Read more here!
...
![virtio diagram](/linaro-website/images/blog/virtio)
