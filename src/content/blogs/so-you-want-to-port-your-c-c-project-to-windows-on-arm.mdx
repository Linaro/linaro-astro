...
description: >
  Looking for a quick answer? There are several approaches that can be taken to
  get a project running on Windows on Arm devices. Each is discussed with some
  context in this article, however, native ARM64 with LLVM is usually the
  fastest choice for your application.
