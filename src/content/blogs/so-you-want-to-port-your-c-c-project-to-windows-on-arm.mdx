...
<a id="citation-1"></a> [Blender 5.0.1 with the "Classroom" scene, using the cycles render engine in CPU mode](https://code.blender.org/2025/08/blender-for-windows-on-arm/)
