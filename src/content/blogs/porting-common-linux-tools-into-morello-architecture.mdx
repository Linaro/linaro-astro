...
[https://git.morello-project.org/morello/android/platform/external/curl/-/merge\_requests/1](https://git.morello-project.org/morello/android/platform/external/curl/-/merge_requests/1)
