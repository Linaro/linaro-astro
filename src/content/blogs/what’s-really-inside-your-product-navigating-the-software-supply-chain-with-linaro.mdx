...
title: What’s Really Inside Your Product? Navigating the Software Supply Chain
  with Linaro
description: >
  For more than 15 years, Linaro has helped embedded device manufacturers build
  secure, high-quality products at scale. Our engineering teams work at the
  intersection of product development and upstream open source, collaborating
  directly with the communities that provide a significant portion of the
  software used in modern devices.
date: 2026-02-12T14:27:00.000Z
author: joe-sandom
tags:
  - iot-embedded
  - security
...
* **Tracking the Software Supply Chain:** We break down the analogy of a modern device, and we explain how to track these components effectively using build-time analysis. 
...
* **Common Vulnerability Exploits (CVE’s):** A look into CVE classification, managing vulnerabilities at scale, and achieving continuous monitoring. 
