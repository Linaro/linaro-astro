...
description: >
  Contributing to the Linux kernel can seem daunting and complex. In this
  three-part blog series, we will share our experience sending patches to the
  Linux kernel and interacting with the community. Check out our first blog to
  learn how to prepare, format, and post your first patch!
date: 2025-09-16T00:00:00.000Z
image: >-
  https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/IMG_0548_oth5pe.jpg
tags:
  - linux-kernel
  - open-source
...
![Most active 6.16 employers](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/most_active_6.16_emplyers_s4wf03.png)
...
3. **Tags**: At the end of the commit message there are machine-readable tags:
   ...
   1. Signed-off-by: `"Your RealName <your.email@example.com>"`.
   ...
   2. Fixes: `<commit hash> (“original commit message”)`.
   ...
   3. Reported-by: `"Reporter RealName <reporter.email@example.com>"`.
      Use this to give credit to the person who initially reported the bug.
   4. Link: https://lore.kernel.org/r/.../  
