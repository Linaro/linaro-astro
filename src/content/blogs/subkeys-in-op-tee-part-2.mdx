...
description: >-
  Up to now, Trusted Applications (TAs) for OP-TEE could be signed and later
  verified by a single certificate. When multiple vendors are involved though
  having a single signer doesn’t scale well. A while back we took a quick look
  at the subkeys implemented in OP-TEE. In this blog, we will do a deep dive on
  the implementation.
date: 2024-04-26T01:48:55.000Z
image: >-
...
![Hierarchy of Keys](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/hierarchy-of-keys)
...
![namespace with UUIDv5](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/namespace-with-uuidv5-figure)
...
![multiple subkey levels](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/multiple-subkey-levels)
...
![using root key only](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/using-root-key-only)
...
![adding an identity subkey](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/adding-an-identity-subkey)
...
OP-TEE currently supports subkeys using TEE\_ALG\_RSASSA\_PKCS1\_PSS\_MGF1\_SHA256 and TEE\_ALG\_RSASSA\_PKCS1\_V1\_5\_SHA256 for signing and verification, but the format can easily support any algorithm supported by GlobalPlatform TEE Core Internal API \[4].
...
![ta verified with two subkeys](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/ta-verified-with-two-subkeys)

**Figure 8: TA verified with two subkeys**

A TA verified by an Identity subkey is handled similarly to other subkeys.

![ta verified with an identity subkey](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/ta-verified-with-an-identity-subkey)
...
Thank you for reading this far. This concludes the two-part series on subkeys in OP-TEE. If you have any questions or thoughts feel free to create an issue at [https://github.com/OP-TEE/optee\_os/issues](https://github.com/OP-TEE/optee_os/issues) or to reach out on the mailing list. You’re also welcome to join the LOC meetings.
...
3. OP-TEE documentation, subkey section [https://optee.readthedocs.io/en/latest/architecture/subkeys.html](https://optee.readthedocs.io/en/latest/architecture/subkeys.html)
