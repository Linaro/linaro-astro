...
![Hierarchy of Keys](/linaro-website/images/blog/hierarchy-of-keys)
...
![namespace with UUIDv5](/linaro-website/images/blog/namespace-with-uuidv5-figure)
...
![multiple subkey levels](/linaro-website/images/blog/multiple-subkey-levels)
...
![using root key only](/linaro-website/images/blog/using-root-key-only)
...
![adding an identity subkey](/linaro-website/images/blog/adding-an-identity-subkey)
...
![ta verified with two subkeys](/linaro-website/images/blog/ta-verified-with-two-subkeys)

**Figure 8: TA verified with two subkeys**

A TA verified by an Identity subkey is handled similarly to other subkeys.

![ta verified with an identity subkey](/linaro-website/images/blog/ta-verified-with-an-identity-subkey)
