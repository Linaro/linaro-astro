...
![OP-TEE, U-BOOT & Firmware volume Block Protocol architecture diagram](/linaro-website/images/blog/firmware-volume-block-protocol-architecture)
...
The StandAloneMM binary is located at *Build/MmStandaloneRpmb/RELEASE\_GCC5/FV/BL32\_AP\_MM.fd*
