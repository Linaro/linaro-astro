...
description: >-
  ...
  variety of attacks. On Arm servers and desktops, which typically run EDK2,
  dedicated flashes are used. Those would normally be accessible from the secure
  world only, since they are storing critical variables for our systems
  integrity and security.
date: 2021-01-04T01:21:12.000Z
image: >-
...
![OP-TEE, U-BOOT & Firmware volume Block Protocol architecture diagram](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/firmware-volume-block-protocol-architecture-898-9f96a2_vv52sn.webp)
