...
tags:
  ...
  - linux-kernel
  - open-source
image: https://res.cloudinary.com/dl7c2wmhi/image/upload/v1787298979/linaro-website/IMG_3626_ncuv5i.png
related: []
---
...
* [Arm FF-A virtio-msg buds binding](https://documentation-service.arm.com/static/68f647791134f773ab3f0a7c) **(informative)** – An example of how virtio-msg can be transported over the Arm Firmware Framework for Arm A-profile (FF-A), illustrating one possible bus binding while remaining separate from the transport specification itself.
* [HVAC](https://linaro.atlassian.net/wiki/spaces/HVAC/overview) (Heterogeneous VirtIO for Automotive Computing)  **overview** – Background on the initiative that originally motivated the development of virtio-msg and explores its application to heterogeneous embedded and automotive platforms.
