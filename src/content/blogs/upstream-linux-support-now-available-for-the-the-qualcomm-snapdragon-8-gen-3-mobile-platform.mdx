...
![On the left Screenshot of CPU Info (open-source) App showing information on the running system. On the right: FishTank WebGL sample running in Firefox for Android](/linaro-website/images/blog/snapdragon-8-gen-3-mobile-platform)

![On the left: Picture of a Qualcomm Development Kit with the attached debug board. On the right: Screenshot of the Android Version menu showing the device running Android 14 and running the v6.6-rc6 based Linux tree](/linaro-website/images/blog/development-kit-and-screenshot-of-the-android-version-menu-)
