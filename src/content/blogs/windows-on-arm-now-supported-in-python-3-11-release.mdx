...
Python has been very successful thanks to its rich ecosystem, and especially pip packages ([https://pypi.org/](https://pypi.org/)). Some packages use native code (mostly C/C++), which usually involve some efforts to enable a new platform.
...
* How to compile a single C/C++ file ([VSCMD\_ARG\_TGT\_ARCH](https://setuptools.pypa.io/en/latest/history.html#v57-2-0))
* How to package libraries in a wheel file ([SETUPTOOLS\_EXT\_SUFFIX](https://setuptools.pypa.io/en/latest/history.html#v57-4-0))
