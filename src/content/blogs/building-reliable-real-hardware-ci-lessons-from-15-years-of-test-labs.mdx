...
| Harness       | Software to test                  | Architecture                 | Testing Community                                                          |
| ------------- | --------------------------------- | ---------------------------- | -------------------------------------------------------------------------- |
| Gitlab/Github | User space                        | Runner                       |                                                                              |
| Labgrid       | Firmware, Kernel, OS, user space  | Single process               | KernelCI, …                                                                  |
| LAVA          | Firmware, Kernel, OS, user space  | On server, multiple workers  | KernelCI, Onelab, Civil Infrastructure Platform, Automotive Grade Linux, …   |
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="3">Power On/Off</td>
      <td>ATX Power Supply</td>
      <td rowspan="2">Managed relays</td>
    </tr>
    <tr>
      <td>Jack Barrel</td>
    </tr>
    ...
    <tr>
      <td>Boot, Enter recovery, …</td>
      <td>Press buttons / toggle dip switches</td>
      <td>Managed relays</td>
    </tr>
    <tr>
      <td>Network services</td>
      <td>DHCP, DNS, NTP, TFTP, …</td>
      <td>Switches and servers</td>
    </tr>
  </tbody>
</table>
