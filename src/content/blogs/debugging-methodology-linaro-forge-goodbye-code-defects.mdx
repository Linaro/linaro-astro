...
![Methodology-debugging technique](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/methodology-debugging-technique)
...
![the DDT logbook](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/the-ddt-logbook)
...
![Configurable breakpoints](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/configurable-breakpoints)
...
![Tracepoints](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/tracepoints)
...
![Html formatted output from a linaro ddt offline run](https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog/html-formatted-output-from-a-linaro-ddt-offline-run)

## Continuing the Journey

In this article I focused on adopting a methodology for debugging.   I  introduced a few of the Linaro DDT features that support that goal but this barely scratches the surface of the debugger’s features.  To obtain more information on Forge please visit us at [https://www.linaroforge.com](https://www.linaroforge.com).   Also, if you would like to schedule an overview presentation of our tools please contact the Forge sales team at **sales@forge.linaro.com**.
