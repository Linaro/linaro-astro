...
description: >
  This blog post documents the introduction of the 'wget cacert' command in
  U-Boot which adds support for CA Certificates.
date: 2025-06-12T00:00:00.000Z
image: >-
  https://res.cloudinary.com/dl7c2wmhi/image/upload/v1758792170/linaro-website/images/blog-hero-images/circuit_ogibqv
tags:
  - u-boot
  - security
