...
![Power = C x freq x V squared](/linaro-website/images/blog/formula)
...
![Power Consumption chart](/linaro-website/images/blog/power-consumption)
...
![development board thermal profile graph](/linaro-website/images/blog/development-board-thermal-profile)
...
![Duty Cycle chart](/linaro-website/images/blog/duty-cycle)
...
![Kernel Traces graph](/linaro-website/images/blog/kernel-traces)
...
![comparison between the DVFS and the idle injection charts](/linaro-website/images/blog/dvfs-idle-injection-comparision)
