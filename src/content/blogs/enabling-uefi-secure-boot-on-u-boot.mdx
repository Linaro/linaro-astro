...
description: >
  In this article, Takahiro Akashi looks at how UEFI Secure Boot on U-Boot works
  and what it is designed to protect you against. Read about it here!
date: 2020-09-28T01:15:38.000Z
...
CONFIG\_EFI\_SECURE\_BOOT is the only option required in addition to qemu\_arm64\_defconfig to support UEFI Secure Boot.
...
Here, interim "PK" and "KEK" are created as self-signed certificates, while "db" should contain the certificate, dubbed "rh\_ca.crt", from step (3).
...
**\[1][https://uefi.org/](https://uefi.org/)**

**\[2][https://github.com/ARMsoftware/ebbr/](https://github.com/ARM-software/ebbr/)**

**3][https://access.redhat.com/articles/5254641](https://access.redhat.com/articles/5254641)**

**\[4][https://docs.microsoft.com/en-us/windows-hardware/design/device-experiences/oem-secure-boot](https://docs.microsoft.com/en-us/windows-hardware/design/device-experiences/oem-secure-boot)**

**\[5][https://eclypsium.com/2020/07/29/theres-a-hole-in-the-boot/](https://eclypsium.com/2020/07/29/theres-a-hole-in-the-boot/)**
