...
![Sampling settings dialog for the WindowsPerf GUI](/linaro-website/images/blog/configuring-the-sampling-parameters)
...
![Sampling explorer window for WindowsPerf GUI](/linaro-website/images/blog/implementing-code-adjustments-1)
...
![How to open a file from the sampling explorer in WindowsPerf GUI](/linaro-website/images/blog/implementing-code-adjustments-2)
